# -*- coding: utf-8 -*-
"""
Created on Thu Feb 10 18:20:58 2022
...
result_folder_name = "result_final2/"



# defining Function (sin (5 pi x)) / 5 pi x

Y_func = lambda x : torch.sgn((torch.sin(5*torch.pi*x)))
...
plot_grad_norm(g2.values(),result_folder_name+"model1_"+ grad_norm_name)
