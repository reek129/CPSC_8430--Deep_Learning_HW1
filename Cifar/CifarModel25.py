# -*- coding: utf-8 -*-
"""
Created on Fri Feb 18 10:51:02 2022
...
class Cifar_model25(nn.Module):
    def __init__(self):
        super().__init__()
        # Convolution Layers
        self.conv1 = nn.Conv2d(3,16,kernel_size = 3,stride=1,padding=1)
        self.conv2 = nn.Conv2d(16,64,kernel_size = 3,stride=1,padding=1)
        self.conv3 = nn.Conv2d(64,20,kernel_size = 3,stride=1,padding=1)
        
        self.conv4 = nn.Conv2d(20,24,kernel_size = 3,stride=1,padding=1)
        self.conv5 = nn.Conv2d(24,16,kernel_size = 3,stride=1,padding=1)
