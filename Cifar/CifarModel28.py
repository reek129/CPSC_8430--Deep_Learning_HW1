# -*- coding: utf-8 -*-
"""
Created on Fri Feb 18 10:54:10 2022
...
class Cifar_model28(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(20,100,kernel_size = 3,stride=1,padding=1)
        self.conv5 = nn.Conv2d(100,16,kernel_size = 3,stride=1,padding=1)
