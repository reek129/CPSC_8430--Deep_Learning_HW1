# -*- coding: utf-8 -*-
"""
Created on Fri Feb 18 10:52:25 2022
...
class Cifar_model26(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(20,30,kernel_size = 3,stride=1,padding=1)
        self.conv5 = nn.Conv2d(30,16,kernel_size = 3,stride=1,padding=1)
