# -*- coding: utf-8 -*-
"""
Created on Fri Feb 18 10:48:39 2022
...
class Cifar_model23(nn.Module):
    def __init__(self):
        super().__init__()
        # Convolution Layers
        self.conv1 = nn.Conv2d(3,16,kernel_size = 3,stride=1,padding=1)
        self.conv2 = nn.Conv2d(16,10,kernel_size = 3,stride=1,padding=1)
        self.conv3 = nn.Conv2d(10,32,kernel_size = 3,stride=1,padding=1)
        
        self.conv4 = nn.Conv2d(32,20,kernel_size = 3,stride=1,padding=1)
        self.conv5 = nn.Conv2d(20,16,kernel_size = 3,stride=1,padding=1)
