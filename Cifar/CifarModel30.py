# -*- coding: utf-8 -*-
"""
Created on Fri Feb 18 10:55:35 2022
...
class Cifar_model30(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(32,128,kernel_size = 3,stride=1,padding=1)
        self.conv5 = nn.Conv2d(128,32,kernel_size = 3,stride=1,padding=1)
